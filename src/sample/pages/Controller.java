...
public class Controller {
   ...
   void initialize() {
      ...
      choiceBox.getItems().add("HardwareEngineer");
      ...
      employees.clear();
      employees.add(new Teacher("11", "22", 23, Teacher.Subject.Physicist));
            ...
            switch (choiceBox.getValue()) {
               ...
               case "HardwareEngineer":
                  if (!programmers.isEmpty()) {
                     ...
                     HardwareEngineer sys = (HardwareEngineer) emp;
   ...
   private void setChoice(Employee init) {
      ...
      switch (name) {
         case "Builder":
            ...
            break;
         case "Teacher":
            addBox.setValue(((Teacher) init).getSubject().toString());
            break;
         case "Medic":
         ...
         case "SystemAdministrator":
            if (!programmers.isEmpty()) {
               Programmer programmer = ((HardwareEngineer) init).getProgrammer();
